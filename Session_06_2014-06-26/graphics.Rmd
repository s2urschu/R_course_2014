...
#Mit pdf(name) und def.off() kann die Graphik in einer PDF gespeichert werden. Aber entweder PDF oder Knit!
#pdf('out.pdf') 
# Alles kann man in ?par nachlesen.
...
# Mit table(POS) kann man sich ein Kuchendiagramm in textueller Form anzeigen lassen. 
# Mit prop.table(table(POS)) kann man sich die relative Frequenz der Werte der Tabelle anzeigen lassen.
